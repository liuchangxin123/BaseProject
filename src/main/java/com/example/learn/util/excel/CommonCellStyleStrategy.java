package com.example.learn.util.excel;
...
/**
 * @ClassName CommonCellStyleStrategy
 * @Description exsyExcel通用的格式策略工具类
...
public class CommonCellStyleStrategy {
    ...
    public static HorizontalCellStyleStrategy getHorizontalCellStyleStrategy() {
        ...
        contentCellStyle.setFillForegroundColor(IndexedColors.LIGHT_CORNFLOWER_BLUE.getIndex());
        // 设置内容靠左对齐
